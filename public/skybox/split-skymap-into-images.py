...
def processImage(path, name):
	...
	"""splitAndSave(img, 0, size, size, addToFilename(name, "_right"))
	splitAndSave(img, size*3, size, size, addToFilename(name, "_back"))
	splitAndSave(img, size * 2, size, size, addToFilename(name, "_left"))
...
"""
	splitAndSave(img, 0, size, size, "nx.png")
	splitAndSave(img, size*3, size, size, "nz.png")
	splitAndSave(img, size * 2, size, size, "px.png")
	splitAndSave(img, size, size*2, size, "ny.png")
	splitAndSave(img, size, 0, size, "py.png")
	splitAndSave(img, size, size, size, "pz.png")
